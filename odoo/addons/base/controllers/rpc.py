...
class RPC(Controller):
    ...
    @route("/xmlrpc/<service>", auth="none", methods=["OPTIONS", "POST"], csrf=False, save_session=False, cors='*')
    ...
    @route("/xmlrpc/2/<service>", auth="none", methods=["OPTIONS", "POST"], csrf=False, save_session=False, cors='*')
